 ...
 * 
 * @author angelyin
 * @date 2015-10-20 上午11:17:57
 */
public class AllCustomerData implements Serializable {
	private static final long serialVersionUID = -3566193981309306493L;
	/** 页头类 **/
	 ...
	 */
	public class BBody {
		public GgetCustomerData getCustomerData;

		public GgetCustomerData getGetCustomerData() {
			return getCustomerData;
		}

		public void setGetCustomerData(GgetCustomerData getCustomerData) {
			this.getCustomerData = getCustomerData;
		}

		public class GgetCustomerData {
			public List<DData> data;
			private String count;

			public List<DData> getData() {
				return data;
			}

			public void setData(List<DData> data) {
				this.data = data;
			}
