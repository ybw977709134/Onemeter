 ...
 * 
 * @author angelyin
 * @date 2015-10-14 上午10:47:00
 */
public class NewLeadStateActivity extends BaseActivity implements
	...
	private void getStatus() {
		...
		new NetUtil(this).sendPostToServer(params,
				Constants.API_TIANJIA_STATUS, this, "getStatusData");
	}
...
//			toast("获取状态成功");
	...
	public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
		...
		intent.putExtra("oone", str);
		intent.putExtra("oone_id", state_id);
		if (resultCode.equals("5555")) {
			setResult(5555, intent);
		} else if (resultCode.equals("11")) {
			setResult(11, intent);
		}else if(resultCode.equals("5151")){
			setResult(5151, intent);
		}else if(resultCode.equals("212121")){
			setResult(212121, intent);
		}
