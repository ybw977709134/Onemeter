 ...
 */
public class NewLeadEditActivity extends BaseActivity implements
		OnClickListener {
	/** 联系方式（点击） **/
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.newlead_edit_layout);
	...
	private void getNetCustomerDataBy() {
		...
		new NetUtil(this).sendPostToServer(params,
				Constants.API_CUSTOMER_DATABY_MSG, NewLeadEditActivity.this,
				"getCustomerDataById");

	}

	private void initView() {
		button_edit_cancel = (Button) findViewById(R.id.button_edit_cancel);
		button_edit_cancel.setOnClickListener(this);
		button_edit_next = (Button) findViewById(R.id.button_edit_next);
		button_edit_next.setOnClickListener(this);
		linearLayout_edit_sex = (LinearLayout) findViewById(R.id.linearLayout_edit_sex);
		linearLayout_edit_birthday = (LinearLayout) findViewById(R.id.linearLayout_edit_birthday);
		linearLayout_edit_class = (LinearLayout) findViewById(R.id.linearLayout_edit_class);
		...
		tx_birthday = (TextView) findViewById(R.id.tx_birthday);
		editText_edit_student_name = (EditText) findViewById(R.id.editText_edit_student_name);
		editText_edit_like_class = (EditText) findViewById(R.id.editText_edit_like_class);
		edt_sex = (TextView) findViewById(R.id.edt_sex);
		edt_grahf_class = (TextView) findViewById(R.id.edt_grahf_class);
	...
	public void onClick(View view) {
		...
		case R.id.button_edit_cancel:
			...
			finish();
			break;
		case R.id.button_edit_next:
			// 下一步
			getUpdateDate();

			break;
		case R.id.linearLayout_edit_sex:
			// 修改性别
			...
			break;
		case R.id.linearLayout_edit_birthday:
			// 修改生日
			popupWindow();
			break;
		case R.id.linearLayout_edit_class:
			// 修改年级
			Intent intent3 = new Intent(this, NewLeadClassActivity.class);
			intent3.putExtra("requestCode", "4444");
			startActivityForResult(intent3, 3030);
			break;
...
//		}
	...
	private void intDataView() {
		// 设置学生姓名
		editText_edit_student_name.setText(gcdylist.get(0).getStudent_name()
				.toString());
