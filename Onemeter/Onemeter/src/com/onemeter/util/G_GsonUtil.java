...
public class G_GsonUtil {
	 ...
	 * 
	 * @param inputStream
	 *            要转换成Java对象的inputStream
	 * @param javaBean
	 *            List获取Map中所包含的javaBean
	 * @param convertFlag
	 *            转换类型标识
	 * @return Object:Java对象
	 */
	public static Object convertJson2Object(InputStream inputStream,
			Class<?> javaBean, int convertFlag) {
		gson = new Gson();
		Object object = null;
	 ...
	 * @return
	 */
	public static Object convertJson2Object(String jsoStr, Class<?> javaBean,
			int convertFlag) {
		gson = new Gson();
		Object object = null;
		Type type = getType(javaBean, convertFlag);
	...
	private static Type getType(Class<?> javaBean, int convertFlag) {
		...
		case JSON_LIST:
			...
			// }
			// javaBean的类型
			// if (javaBean.equals(House.class)) {
			// type = new TypeToken<ArrayList<House>>(){}.getType();
			// }
			break;
		case JSON_MAP:
	 ...
	 * @return
	 */
	private static BufferedReader intputStream2BufferedReader(
